                    ...
                    return o.default.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                }), U = P.getURL(), g.hasBasePath(U) && (U = g.delBasePath(U)), q.scriptLoader && (0, r(3573).zD)(q.scriptLoader), W = new E.default(q.buildId, t), n = function(e) {
                                    var t = f(e, 2),
                                        r = t[0],
                                        n = t[1];
                ...
                return t = e, r = [{
                    ...
                    value: function(t, r, n, a, i) {
                        ...
                        return u(o.default.mark((function u() {
                            var s, y, v, m, _, P, E, R, j, F, q, B, z, G, V, $, X, Y, K, Q, J, Z, ee, te, re, ne, oe, ae, ie, ue, ce, se, le, fe, pe, de, he, ye, ve, me, ge, be, we;
                            return o.default.wrap((function(o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 3:
                                        s = a._h || a._shouldResolveHref || C(r) === C(n), y = l({}, c.state), a._h && (c.isReady = !0), v = y.locale, o.next = 19;
                                        break;
                                    case 19:
                                        if (a._h || (c.isSsr = !1), g.ST && performance.mark("routeChange"), m = a.shallow, _ = void 0 !== m && m, P = a.scroll, E = void 0 === P || P, R = {
                                                shallow: _
                                            }, c._inFlightRoute && c.abortComponentLoad(c._inFlightRoute, R), n = L(k(M(n) ? T(n) : n, a.locale, c.defaultLocale)), j = A(M(n) ? T(n) : n, y.locale), c._inFlightRoute = n, F = v !== y.locale, a._h || !c.onlyAHashChange(j) || F) {
                                            o.next = 36;
                                            break
                                        }
                                    ...
                                    case 55:
                                        if (c.urlIsNew(j) || F || (t = "replaceState"), $ = n, B = B ? p.removePathTrailingSlash(T(B)) : B, !s || "/_error" === B) {
                                            o.next = 70;
                                            break
                                        }
                                    ...
                                    case 65:
                                        ...
                                        break;
                                    case 69:
                                        q.pathname = W(B, G), q.pathname !== B && (B = q.pathname, q.pathname = L(B), r = O.formatWithValidation(q));
                                    case 70:
                                        if (I(n)) {
                                            o.next = 75;
                                            break
                                    ...
                                    case 75:
                                        if ($ = A(T($), y.locale), a.shallow && 1 !== a._h || 1 === a._h && !b.isDynamicRoute(p.removePathTrailingSlash(B))) {
                                            o.next = 96;
                                            break
                                        }
                                    ...
                                    case 112:
                                        return e.events.emit("routeChangeStart", n, R), o.prev = 113, o.next = 117, c.getRouteInfo(K, B, z, n, $, R, y.locale, y.isPreview);
                                    case 117:
                                        ...
                                        return (pe = w.parseRelativeUrl(fe)).pathname = W(pe.pathname, G), de = U(c, fe, fe), he = de.url, ye = de.as, o.abrupt("return", c.change(t, he, ye, a));
                                    case 127:
                        ...
                        return u(o.default.mark((function a() {
                            ...
                            return o.default.wrap((function(o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 27:
                                        return "rewrite" === (v = o.sent).type && (i.pathname = v.resolvedHref, u = v.resolvedHref, c = l({}, c, v.parsedAs.query), f = v.asPath, e = O.formatWithValidation(i)), m = p.removePathTrailingSlash(u), o.next = 32, Promise.all([n.pageLoader._isSsg(m).then((function(t) {
                        ...
                        return u(o.default.mark((function r() {
                            ...
                            return o.default.wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    ...
                                    case 21:
                                        return u = w.parseRelativeUrl(v.normalizeLocalePath(M(i.rewrite) ? T(i.rewrite) : i.rewrite, t.locales).pathname), c = p.removePathTrailingSlash(u.pathname), e.pages.includes(c) ? (s = !0, l = c) : (l = W(c, e.pages)) !== u.pathname && e.pages.includes(l) && (s = !0), r.abrupt("return", {
                                            type: "rewrite",
                                            asPath: u.pathname,
                                            parsedAs: u,
                                            matchedPage: s,
                                    ...
                                    case 27:
                                        ...
                                        return d = p.removePathTrailingSlash(v.normalizeLocalePath(M(i.redirect) ? T(i.redirect) : i.redirect, t.locales).pathname), h = U(t, d, d), y = h.url, m = h.as, r.abrupt("return", {
                                            type: "redirect",
                                            newUrl: y,
                                            newAs: m
                                        });
